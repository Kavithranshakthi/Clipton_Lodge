    <div class="sidebar-menu">
                    <header class="logo1">
                      <span style="color:#000; font-size:26px; font-weight:bold">CLIPTON</span>
                           ...
                           <div class="menu">
                                    ...
                                    <li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Reports</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                                         <ul id="menu-academico-sub" >
                                            ...
                                            <li id="menu-academico-boletim" ><a href="income-month-reports.php">Income B/W M Reports</a></li>
                                            <li id="menu-academico-boletim" ><a href="customer-betdates-reports.php">Customer B/W Reports</a></li>
                                          </ul>
                                     </li>
