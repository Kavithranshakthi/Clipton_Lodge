									...
									<div class="forms">
										<div class="form-grids widget-shadow" data-example-id="basic-forms">
											<div class="form-title">
												<h4>Between Dates Bookings Incomes Report</h4>
											</div>
												...
												<table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
													<thead>
														<tr>
															...
															<th class="d-none d-sm-table-cell">Customer Mobile Number</th>
													...
													<tbody>
														...
														$sql = "SELECT tbluser.*,tblbooking.BookingNumber,tblbooking.ID,tblbooking.Status,tblbooking.BookingDate,tblbooking.Total_Booking_Amount  from tblbooking join tbluser on tblbooking.UserID=tbluser.ID where date(BookingDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
